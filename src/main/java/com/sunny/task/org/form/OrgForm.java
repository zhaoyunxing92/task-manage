...
public class OrgForm extends BaseForm<Long> {
     ...
     * 组织描述
     */
    @Length(min = 0, max = 450, message = "团队名描述{min}-{max}个字符之间", groups = {UpdateGroup.class})
    private String description;
    /**
     * 简介
     */
    @Length(min = 0, max = 50, message = "团队名简介{min}-{max}个字符之间", groups = {UpdateGroup.class})
    private String intro;
    /**
     * 地址
     */
    @Length(min = 0, max = 450, message = "团队地址{min}-{max}个字符之间", groups = {UpdateGroup.class})
