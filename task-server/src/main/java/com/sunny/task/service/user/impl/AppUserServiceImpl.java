...
import com.sunny.task.mapper.user.AppUserExtendMapper;
import com.sunny.task.mapper.user.AppUserMapper;
import com.sunny.task.model.user.AppUser;
import com.sunny.task.model.user.AppUserExtend;
...
/**
 * @author sunny
 * @className com.sunny.task.service.user.impl.AppUserServiceImpl
